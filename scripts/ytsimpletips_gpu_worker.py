...
JOB_PAYLOAD = {"script": "hidden metal detector?  Phone-\u0bb2\u0bcd secret setting  Open Compass app  Activate metal mode  Hold phone near wall  Feel subtle vibration  Metal pipe appears  Mark the spot  Try garden search  Detect lost keys  Zero extra cost  Save time instantly  No extra app needed  Works anywhere  aana wait pannunga, twist!  Try hidden pipe now  Share your find  Boost daily efficiency  No extra battery drain  Works on iOS too  No internet required  Easy step by step  Try it today  Share with friends  Comment your find  Stay tuned for more  Thanks for watching  Stay smart everyday  Catch you later  VJ out!", "custom_map": {"Metal": "Meh-tal", "Detector": "De-tek-tor"}, "elevenlabs_api_key": "sk_b195e57ea3ba70946492f7c037cc86edd691b9b3aec66bf2", "elevenlabs_voice_id": "8Oo4d9mNNwVwK369qOwl", "face_path": "assets/video/blue_python.mp4"}
import os
