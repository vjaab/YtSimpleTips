...
JOB_PAYLOAD = {"script": "Background apps myth  Battery drain real  OS freeze already  Settings open now  Optimize battery  Manual close tip  Check stats live  Surprise results show  aana wait pannunga, twist irukku!  Hidden setting reveal  Boost performance instantly  Phone feels faster  Save battery today  No more myths  Try it now  Secret setting works!", "custom_map": {"NVIDIA": "In-vid-yah"}, "elevenlabs_api_key": "sk_b195e57ea3ba70946492f7c037cc86edd691b9b3aec66bf2", "elevenlabs_voice_id": "8Oo4d9mNNwVwK369qOwl", "face_path": "assets/video/black_vest.mp4"}
import os
