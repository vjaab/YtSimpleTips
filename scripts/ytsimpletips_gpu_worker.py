...
JOB_PAYLOAD = {"script": "Phone-\u0bb2\u0bcd hidden level!  Frame crooked, frustration.  Traditional level, heavy.  Cash waste, space taken.  Phone already has tool.  Open Compass app now.  Swipe bottom left corner.  Level icon appears.  Tap level icon.  Hold phone to wall.  Watch zero degrees display.  Tilt phone till zero.  Nail frame, instantly straight.  aana wait pannunga, twist irukku!  No extra app needed.  Battery just 2% used.  Save time, impress friends.  Accuracy 0.1 degree.  Works for shelves too.  Repeat anytime, anywhere.  Try it now!  Comment your best hack!  Which tool you love?  Stay smart, VJ style.  Subscribe for more tips.  Like & share video.  Thanks for watching!", "custom_map": {"NVIDIA": "In-vid-yah"}, "elevenlabs_api_key": "sk_b195e57ea3ba70946492f7c037cc86edd691b9b3aec66bf2", "elevenlabs_voice_id": "9ebDuCWUuBE6opsuSrhG", "face_path": "assets/video/blue_python.mp4"}
import os
